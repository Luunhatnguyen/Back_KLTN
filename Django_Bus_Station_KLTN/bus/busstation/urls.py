...
router.register(prefix='hireoptions', viewset=views.HireOptionViewSet, basename='hireoption')
...
router.register(prefix='buss_post', viewset=views.BusPostViewSet, basename='buss_post')
...
router.register(prefix='carrierview', viewset=views.ViewCarrierViewSet, basename='carrier')
