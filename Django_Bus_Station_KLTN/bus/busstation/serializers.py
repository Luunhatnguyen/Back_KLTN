...
class HireOptionSerializer(serializers.ModelSerializer):
    class Meta:
        model = HireOption
        fields = '__all__'
...
class CarrierViewSerializer(serializers.ModelSerializer):
    optionID = HireOptionSerializer()
    garageID = GarageSerializer()
    image = serializers.SerializerMethodField()
